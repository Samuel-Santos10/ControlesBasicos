...
public class MainActivity2 extends AppCompatActivity {
    ...
    private void guardarDatosFirebase(){
        try {
            ...
            usuarios user = new usuarios(nombre, "usis022519@ugb.edu.sv", urlCompletaImg, urlCompletaImgFirestore, miToken );
            if (id != null) {
        ...
        imgFoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
                    ...
                    if (photoFile != null) {
                        try {
                            Uri photoURI = FileProvider.getUriForFile(MainActivity2.this, "com.example.ControlesBasicos.fileprovider", photoFile);
