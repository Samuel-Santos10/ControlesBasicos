...
public class ValoresTodos {
    ...
    Spinner val;
    double valores[][] = {
            new double[]{1, 8.75, 105.79, 74.94, 24.58, 22.08, 0.000084, 7.68, 0.88,34,80}, //Valores de monedas
            new double[] {1, 100, 39.3701, 3.28084, 1.1963081929167, 1.09361, 0.001, 0.000621371, 1000, 1e+6},//Valores de Longitud
            new double[] {1, 1000, 0.001, 0.264172, 0.0353147, 104.1666, 61.0237, 35.1951, 56.3121, 168.936 }, //Valores de Volumen
            new double[] {1, 1000, 1000000 , 1000000000, 2.20462, 35.274, 0.001, 0.157473, 1e-6, 10}, //Valores de Masa
            new double[] {1, 1024, 1048576, 9.77e-4, 9.54e-7, 9.3e-10, 9.09e-13, 8388608, 2097152, 8192}, //Valores de Almacenamiento
